 ...
 * @phpstan-type LexUserTypeJson = LexArrayJson | LexBlobJson | LexBooleanJson | LexIntegerJson | LexObjectJson | LexRecordJson | LexStringJson | LexTokenJson | LexUnknownJson | LexXrpcProcedureJson | LexXrpcQueryJson
 */
