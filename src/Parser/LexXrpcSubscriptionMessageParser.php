 ...
 */
class LexXrpcSubscriptionMessageParser implements Parser
{
    use ParserSupport;

    public function parse(object | string $data): LexXrpcSubscriptionMessage
    {
        /** @var TLexXrpcSubscriptionMessage $data */
        $data = $this->validate($data, $this->getValidator());

        return new LexXrpcSubscriptionMessage(
    ...
    /**
     * @phpstan-param TLexXrpcSubscriptionMessage $data
     */
