...
* GitHub Issues: <https://github.com/socialweb/atproto-lexicon/issues>
...
* socialweb/atproto-lexicon follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  socialweb/atproto-lexicon automatically runs tests for pull requests. However,
...
[github]: https://github.com/socialweb/atproto-lexicon
[issues]: https://github.com/socialweb/atproto-lexicon/issues
[pull requests]: https://github.com/socialweb/atproto-lexicon/pulls
